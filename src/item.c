...
void SetBagItemsPointers(void)
{
    ...
    gBagPockets[POCKET_FOSSILS].itemSlots = gSaveBlock1Ptr->bag.fossils;
    gBagPockets[POCKET_FOSSILS].capacity = BAG_FOSSILS_COUNT;
    gBagPockets[POCKET_FOSSILS].id = POCKET_FOSSILS;
}
