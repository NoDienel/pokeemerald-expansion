...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNBLOOMED]                          = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} bloomed!"),
    [STRINGID_PKMNBLOOMFADED]                       = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s bloom faded!"),
    ...
    [STRINGID_PKMN_CHANGED_MODES]                    = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} changes modes!"),
    [STRINGID_PKMN_COCONED_BROKE]                    = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is no longer cocooned!"),
    ...
    [STRINGID_RIVALRY_ACTIVATES]                    = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} has a rivalry with {B_DEF_NAME_WITH_PREFIX2}!"),
...
const u16 gWrappedStringIds[NUM_TRAPPING_MOVES] =
{
    ...
    [B_MSG_WRAPPED_BLOOM]      = STRINGID_PKMNBLOOMED,            // MOVE_BLOOM
};
