...
SINGLE_BATTLE_TEST("Toggle Mode swaps IV/EV contributions")
{
    s16 dmg1;
    s16 dmg2;

    GIVEN {
        PLAYER(SPECIES_WOBBUFFET) { Ability(ABILITY_TOGGLE_MODE); AttackIV(0); SpAttackIV(31); AttackEV(0); SpAttackEV(252); Moves(MOVE_TACKLE); }
