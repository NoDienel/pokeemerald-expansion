...
extern const u8 BattleScript_ToggleModeFlip[];
extern const u8 BattleScript_CocoonBreak[];
...
extern const u8 BattleScript_ResonateReflect[];
extern const u8 BattleScript_SnatchedMove[];
extern const u8 BattleScript_EnduredMsg[];
extern const u8 BattleScript_CriticalParry[];
...
extern const u8 BattleScript_BloomEnds[];
...
extern const u8 BattleScript_CorruptedActivates[];
...
extern const u8 BattleScript_RivalryMessage[];
...
extern const u8 BattleScript_EffectMonkeyAround[];
extern const u8 BattleScript_EffectMonkeyFist[];
extern const u8 BattleScript_EffectMellowMonkey[];
extern const u8 BattleScript_EffectMonkeyBusiness[];
extern const u8 BattleScript_EffectMonkeyMassacre[];
...
extern const u8 BattleScript_EffectBloom[];
