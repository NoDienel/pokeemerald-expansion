...
#define MOVE_MONKEY_AROUND       (FIRST_CUSTOM_MOVE + 2)
#define MOVE_MONKEY_FIST         (FIRST_CUSTOM_MOVE + 3)
#define MOVE_MELLOW_MONKEY       (FIRST_CUSTOM_MOVE + 4)
#define MOVE_MONKEY_BUSINESS     (FIRST_CUSTOM_MOVE + 5)
#define MOVE_MONKEY_MASSACRE     (FIRST_CUSTOM_MOVE + 6)
#define MOVE_SEARING_MONKEY_FIST (FIRST_CUSTOM_MOVE + 7)
#define MOVE_POURING_MONKEY_FIST (FIRST_CUSTOM_MOVE + 8)
#define MOVE_SAGELY_MONKEY_FIST  (FIRST_CUSTOM_MOVE + 9)
#define MOVE_CHITIN_FIST         (FIRST_CUSTOM_MOVE + 10)
#define MOVES_COUNT_CUSTOM       11
