...
enum StringID
{
    ...
    STRINGID_PKMNBLOOMED,
    STRINGID_PKMNBLOOMFADED,
    ...
    STRINGID_PKMN_CHANGED_MODES,
    STRINGID_PKMN_COCONED_BROKE,
    ...
    STRINGID_PKMNMONKEYMINDSET,
    STRINGID_PKMNSABILITYCORRUPTEDTYPEOF,
    STRINGID_COUNT
};
