...
enum __attribute__((packed)) Ability
{
    ...
    ABILITY_PINCH_HITTER = ABILITIES_COUNT_GEN9,
    ABILITY_QUICK_PROTECTOR = 312,
    ABILITY_RESONATE = 313,
    ABILITY_AMPLIFIER = 314,
    ABILITY_SMOOCHER = 315,
    ABILITY_DIZZYING_STEP = 316,
    ABILITY_MASSIVE_STINGER = 317,
    ABILITY_NIGHT_OPERATIVE = 318,
    ABILITY_CRITICAL_PARRY = 319,
    ABILITY_BERRYMADE = 320,
    ABILITY_GREAT_HARVEST = 321,
    ABILITY_JUMP_IN = 322,
    ABILITY_TOGGLE_MODE = 323,
    ABILITY_COCOONED = 324,
    ABILITY_CORRUPTED = 325,
    ABILITY_BLOOM_SPORES = 325,
    ABILITY_PETAL_SKATING = 326,
    ABILITY_FLOWER_POWER = 327,
    ABILITY_SUPERCONDUCT = 328,
    ABILITY_QUEENS_ORDERS = 329,
    ABILITY_SILLY_RASCAL = 330,
    ABILITY_MONKEY_KING = 331,
    ABILITY_ARSENAL = 332,
    ABILITIES_COUNT_EXTRA,
    ABILITIES_COUNT = ABILITIES_COUNT_EXTRA,
};
