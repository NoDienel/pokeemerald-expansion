...
enum __attribute__((packed)) Ability
{
    ...
    ABILITY_BLOOM_SPORES = 326,
    ABILITY_PETAL_SKATING = 327,
    ABILITY_FLOWER_POWER = 328,
    ABILITY_SUPERCONDUCT = 329,
    ABILITY_QUEENS_ORDERS = 330,
    ABILITY_SILLY_RASCAL = 331,
    ABILITY_MONKEY_KING = 332,
    ABILITY_ARSENAL = 333,
